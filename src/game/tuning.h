...
MACRO_TUNING_PARAM(HookLength, hook_length, 425.0f)
...
// weapon tuning
MACRO_TUNING_PARAM(GunCurvature, gun_curvature, 0.1f)
MACRO_TUNING_PARAM(GunSpeed, gun_speed, 2750.0f)
MACRO_TUNING_PARAM(GunLifetime, gun_lifetime, 4.0f)

MACRO_TUNING_PARAM(ShotgunCurvature, shotgun_curvature, 1.0f)
MACRO_TUNING_PARAM(ShotgunSpeed, shotgun_speed, 2000.0f)
MACRO_TUNING_PARAM(ShotgunSpeeddiff, shotgun_speeddiff, 0.8f)
MACRO_TUNING_PARAM(ShotgunLifetime, shotgun_lifetime, 0.165f)

MACRO_TUNING_PARAM(GrenadeCurvature, grenade_curvature, 7.0f)
MACRO_TUNING_PARAM(GrenadeSpeed, grenade_speed, 1500.0f)
MACRO_TUNING_PARAM(GrenadeLifetime, grenade_lifetime, 4.0f)

MACRO_TUNING_PARAM(LaserReach, laser_reach, 2000.0f)
MACRO_TUNING_PARAM(LaserBounceDelay, laser_bounce_delay, 100)
MACRO_TUNING_PARAM(LaserBounceCost, laser_bounce_cost, 50)
